...
- Ver HTML en la derecha re
- magia

# verdadero

- Importe un archivo HTML y observe cómo se convierte mágicamente en Markdown kjh
- jhkjh
...
- Arrastrar y soltar archivos Markdown y HTML en Dillinger Markdown es un lenguaje de marcado ligero basado en las convenciones de formato que la gente usa naturalmente en el correo electrónico. Como escribe [John Gruber] en el [sitio de Markdown][df1]
