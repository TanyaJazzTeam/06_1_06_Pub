...
En Gmail, Thunderbird y Google Groups, puede usar "Markdown Toggle" normalmente: simplemente escriba su respuesta (arriba, abajo, en línea, donde sea) y luego convierta. El correo electrónico original al que estás respondiendo no se modificará. (Técnicamente: los bloques `blockquote` existentes se dejarán intactos).
